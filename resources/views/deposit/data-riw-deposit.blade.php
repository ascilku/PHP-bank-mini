                  ...
                  <div class="table-responsive">
                    ...
                    <table id="example" class="table table-striped table-bordered padding-top padding-bottom" cellspacing="0" width="100%">
                      ...
                      <tbody>
                          ...
                          <?php if (count($query_riw_deposit) > 0): ?>
                              <?php foreach ($query_riw_deposit as $key_query_riw_deposit): ?>
                                    ...
                                    <tr>
                                        <td data-label="Name" >
                                          {{$key_query_riw_deposit->deposit->user->name}}
                                        </td>
                                        <td data-label="Name" >
                                            {{$key_query_riw_deposit->riw_deposit}}
                                          </td>
                                        <td data-label="Name" >
                                          {{$key_query_riw_deposit->created_at}}
                                        </td>
                                        ...
                                        <?php if ($query_nik->akses == 'Admin' || $query_nik->akses == 'Admin Super' ): ?>
                                            ...
                                            <td>  
                                                <a class="hapus_deposit" data-bs-toggle="modal" data-bs-target="#model_hapus_deposit" href="{{route('deposit_hapus')}}??key={{Crypt::encrypt($key_query_riw_deposit->id)}}">
